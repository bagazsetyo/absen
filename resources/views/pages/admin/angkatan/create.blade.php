<div>
    <form method="post" id="createGroup">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama" id="nama" class="form-control" placeholder="Angkatan 2020/2021">
        </div>
        <div>
            <label for="">Tahun</label>
            <input type="text" name="tahun" id="tahun" class="form-control" placeholder="2020">
        </div>
        <div class="mt-3">
