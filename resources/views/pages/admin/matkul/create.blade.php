<div>
    <form method="post" id="createGroup">
        ...
        <div class="form-group input-style-1">
            ...
            <input type="text" name="nama" id="nama" class="form-control" placeholder="Teknik Informatika">
        </div>
        <div class="form-group input-style-1">
        ...
        <div class="input-style-1">
            ...
            <input type="time" id="start-time" name="jam_mulai" data-toggle="datepicker">
        </div>
        <div class="input-style-1">
            <label for="end-time">Jam Selesai:</label>
            <input type="time" id="end-time" name="jam_selesai" data-toggle="datepicker">
        </div>
        <div class="mt-3">
